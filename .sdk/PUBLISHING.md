...
|---|---|---|
| `ts/` | @voxgig-sdk/aareguru-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/aareguru-sdk \
      --repository voxgig-sdk/aareguru-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/aareguru-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/aareguru-sdk --id=<id>` removes one.
