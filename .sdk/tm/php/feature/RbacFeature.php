...
class AareguruRbacFeature extends AareguruBaseFeature
{
    ...
    private function _required(AareguruContext $ctx): ?string
    {
    ...
    private function _reject(AareguruContext $ctx, string $required): void
    {
    ...
    private function _track(AareguruContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
