...
class AareguruNetsimFeature extends AareguruBaseFeature
{
    ...
    private function _simulate(AareguruContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AareguruContext $ctx, array $applied): void
    {
        $client = $this->client;
