...
class AareguruCacheFeature extends AareguruBaseFeature
{
    ...
    private function _through(AareguruContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
