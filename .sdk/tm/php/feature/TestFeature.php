...
class AareguruTestFeature extends AareguruBaseFeature
{
    ...
    public function init(AareguruContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (AareguruContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (AareguruContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(AareguruContext $ctx, $op, $args): array
    {
