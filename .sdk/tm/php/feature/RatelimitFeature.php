...
// Aareguru SDK ratelimit feature
...
class AareguruRatelimitFeature extends AareguruBaseFeature
{
    ...
    private function _acquire(AareguruContext $ctx): void
    {
    ...
    private function _track(AareguruContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
