...
// Aareguru SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = AareguruOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(AareguruOmni::structfix($now, Struct::undef()))
                        !== json_encode(AareguruOmni::structfix($val, Struct::undef()))) {
