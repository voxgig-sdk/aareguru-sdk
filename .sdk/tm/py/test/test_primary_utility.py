...
from projectname_sdk import AareguruSDK
from projectname_sdk.core.spec import AareguruSpec
from projectname_sdk.core.result import AareguruResult
from projectname_sdk.core.response import AareguruResponse
from projectname_sdk.core.operation import AareguruOperation
from projectname_sdk.core.error import AareguruError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import AareguruBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = AareguruSDK.test(None, None)
        ...
        class TestInitFeature(AareguruBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(AareguruBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = AareguruSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = AareguruSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = AareguruSDK.test(None, setup_opts)
