...
class AareguruTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AareguruTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = AareguruTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = AareguruTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
