...
describe("StuffDirect", function()
  it("should direct-load-stuff", function()
    local setup = stuff_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-stuff", setup.live and "live" or "unit")
...
function stuff_direct_setup(mockres)
