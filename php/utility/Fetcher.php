...
class AareguruFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AareguruSDK/1.0)';
    ...
    public static function call(AareguruContext $ctx, string $fullurl, array $fetchdef): array
    {
