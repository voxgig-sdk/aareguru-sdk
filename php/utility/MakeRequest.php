...
// Aareguru SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AareguruMakeRequest
{
    public static function call(AareguruContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AareguruResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AareguruResponse($fetched);
        } else {
