...
class AareguruGraphql
{
    ...
    // equivalent.
    public static function body(AareguruContext $ctx): mixed
    {
    ...
    public static function errors(AareguruContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
