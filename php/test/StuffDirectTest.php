...
class StuffDirectTest extends TestCase
{
    public function test_direct_load_stuff(): void
    {
        $setup = stuff_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-stuff", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
