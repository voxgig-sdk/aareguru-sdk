...
class LegacyEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set AAREGURU_TEST_LEGACY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function legacy_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("AAREGURU_TEST_LEGACY_ENTID");
