...
// Aareguru SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AareguruSDK::test)
...
{
    private const SDK_CLASS = 'AareguruSDK';
    ...
    private const SDK_BASE = 'aareguru_sdk';
