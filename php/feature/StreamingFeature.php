...
// Aareguru SDK streaming feature
...
class AareguruStreamingFeature extends AareguruBaseFeature
{
    ...
    private function _iterate(AareguruResult $result): \Generator
    {
    ...
    private function _streamable(AareguruContext $ctx): bool
    {
