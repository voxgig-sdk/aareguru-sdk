...
// Aareguru SDK clienttrack feature
...
class AareguruClienttrackFeature extends AareguruBaseFeature
{
    ...
    public function PostConstruct(AareguruContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Aareguru-SDK';
