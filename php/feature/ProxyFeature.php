...
class AareguruProxyFeature extends AareguruBaseFeature
{
    ...
    public function init(AareguruContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AareguruContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
