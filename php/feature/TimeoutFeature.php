...
class AareguruTimeoutFeature extends AareguruBaseFeature
{
    ...
    private function _with_timeout(AareguruContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AareguruContext $_ctx, float $ms): void
    {
        $client = $this->client;
