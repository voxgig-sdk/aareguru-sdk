...
func (sdk *AareguruSDK) OptionsMap() map[string]any {
...
func (sdk *AareguruSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AareguruSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AareguruSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AareguruSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *AareguruSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *AareguruSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("AareguruSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *AareguruSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AareguruSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("AareguruSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
