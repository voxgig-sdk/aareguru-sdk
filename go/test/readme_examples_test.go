...
const testSeed = `map[string]any{"entity": map[string]any{"legacy": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "stuff": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "v2018": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
