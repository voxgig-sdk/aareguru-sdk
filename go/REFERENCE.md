# Aareguru Golang SDK Reference

Complete API reference for the Aareguru Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *AareguruSDK`
...
```go
result, err := client.Stuff(nil).Load(map[string]any{"service": "service"}, nil)
if err != nil {
    panic(err)
}
fmt.Println(result)
...
```go
result, err := client.V2018(nil).Load(map[string]any{"city": "city", "end": "end", "start": "start"}, nil)
if err != nil {
    panic(err)
}
fmt.Println(result)
