...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Legacy()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/aareguru-sdk/releases)) or
...
```
py/
├── aareguru_sdk.py         -- Main SDK module
