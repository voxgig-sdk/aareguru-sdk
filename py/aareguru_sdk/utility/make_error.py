...
def make_error_util(ctx, err):
    if ctx is None:
        from aareguru_sdk.core.context import AareguruContext
        ctx = AareguruContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, AareguruError):
        errmsg = err.msg
