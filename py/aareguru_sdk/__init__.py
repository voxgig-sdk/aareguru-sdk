...
from aareguru_sdk.utility import register

# Load features
from aareguru_sdk.feature.base_feature import AareguruBaseFeature
from aareguru_sdk.features import _has_feature, _make_feature
...
class AareguruSDK:
    ...
    def get_utility(self):
        return AareguruUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AareguruSDK: graphql: " + str(msg))
            res["graphql"] = errors
