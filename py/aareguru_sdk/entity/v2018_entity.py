...
class V2018Entity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return V2018Entity(self._client, opts)
    ...
    def load(self, reqmatch=None, ctrl=None) -> V2018:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.V2018().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
