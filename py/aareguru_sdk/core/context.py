...
from aareguru_sdk.core.control import AareguruControl
...
from aareguru_sdk.core.helpers import get_ctx_prop, to_map
...
class AareguruContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, AareguruResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AareguruResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return AareguruError(code, msg, self)
