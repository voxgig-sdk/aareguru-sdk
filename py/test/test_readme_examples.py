# Aareguru SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AareguruSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AareguruSDK(...) and AareguruSDK.test(...) become
#      AareguruSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "aareguru_sdk"
_SDK_CLASS = "AareguruSDK"
