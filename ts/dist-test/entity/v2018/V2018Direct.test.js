...
(0, node_test_1.describe)('V2018Direct', async () => {
    ...
    (0, node_test_1.test)('direct-load-v2018', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-v2018', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['AAREGURU_TEST_V2018_ENTID'];
...
//# sourceMappingURL=V2018Direct.test.js.map