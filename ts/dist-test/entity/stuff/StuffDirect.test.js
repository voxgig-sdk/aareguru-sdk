...
(0, node_test_1.describe)('StuffDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-stuff', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-stuff', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['AAREGURU_TEST_STUFF_ENTID'];
...
//# sourceMappingURL=StuffDirect.test.js.map