...
function envOverride(m) {
    if ('TRUE' === process.env.AAREGURU_TEST_LIVE ||
        'TRUE' === process.env.AAREGURU_TEST_OVERRIDE) {
    ...
    m.AAREGURU_TEST_EXPLAIN = process.env.AAREGURU_TEST_EXPLAIN || m.AAREGURU_TEST_EXPLAIN;
    return m;
}
