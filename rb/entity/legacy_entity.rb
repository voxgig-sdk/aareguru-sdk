...
class LegacyEntity
  ...
  #
  # @param reqmatch [LegacyLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Legacy.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Legacy, Hash] the loaded Legacy; raises AareguruError on failure
