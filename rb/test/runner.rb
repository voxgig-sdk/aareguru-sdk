...
module AareguruTestRunner
  ...
  def self.env_override(m)
    live = getenv("AAREGURU_TEST_LIVE")
    override = getenv("AAREGURU_TEST_OVERRIDE")
    ...
    explain = getenv("AAREGURU_TEST_EXPLAIN")
    m["AAREGURU_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = AareguruTestRunner
Helpers = AareguruHelpers
Vs = VoxgigStruct
