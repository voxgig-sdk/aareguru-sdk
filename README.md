...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/aareguru` | `npm install @voxgig-sdk/aareguru` |
| Python | `voxgig-sdk-aareguru` | `pip install voxgig-sdk-aareguru` |
| PHP | `voxgig-sdk/aareguru` | `composer require voxgig-sdk/aareguru` |
| Golang | `github.com/voxgig-sdk/aareguru-sdk/go` | `go get github.com/voxgig-sdk/aareguru-sdk/go` |
| Ruby | `voxgig-sdk-aareguru` | `gem install voxgig-sdk-aareguru` |
| Lua | `voxgig-sdk-aareguru` | `luarocks install voxgig-sdk-aareguru` |
