// Command Aareguru-cli is a CLI + REPL for the Aareguru SDK,
...
const prompt = "aareguru"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "legacy stuff v2018"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      AAREGURU_APIKEY (api key), AAREGURU_BASE (base url override)")
