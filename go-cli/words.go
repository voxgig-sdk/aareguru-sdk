...
func registerSDKWords(r *eng.Registry, client *sdk.AareguruSDK) {
...
func runOp(client *sdk.AareguruSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
